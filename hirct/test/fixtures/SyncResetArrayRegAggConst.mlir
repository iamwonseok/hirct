module {
  hw.module @SyncResetArrayRegAggConst(in %clock : i1, in %reset : i1, in %d0 : i8, in %d1 : i8, out out0 : i8, out out1 : i8) {
    %arr_d = hw.array_create %d1, %d0 : i8
    %arr_rst = hw.aggregate_constant [42 : i8, 7 : i8] : !hw.array<2xi8>
